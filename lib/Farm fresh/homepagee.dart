...
import 'refracting_farm.dart';
import 'blog_refract_farm.dart';
void main() {
...
class Farm extends StatelessWidget {
  ...
  var categories=[
        "assets/images/cutted.jpg",
        "assets/images/veg.jpg",
        "assets/images/offrrrrrr.jpg",
        "assets/images/cutted.jpg",
        "assets/images/exotic-perrot.jpg",
     ];
  var titles=[
    'OFFERS',
    'VEGETABLES',
  ...
  var imag=[
"assets/images/getty (3).jpg",
    "assets/images/getty (2).jpg",
    "assets/images/getty (1).jpg"
  ];
  var title = [
    'OFFERS',
    'VEGETABLES',
      ...
      return GridView.builder(
        ...
        itemBuilder: (BuildContext context, int gridIndex) {
          return Card(
            child: Column(
              children: [
                Image.network(categories[gridIndex]),
  ...
  3,
  (index) =>Blog(image: NetworkImage(blogimg[index]),
